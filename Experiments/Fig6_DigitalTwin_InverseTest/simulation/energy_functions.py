...
#Some previous comments on parameter values for Holzapfel model.
#Elasticity parameters a,b,a_f,b_f are from
#A Healthy volunteer in the study
#Non-invasive Model-Based Assessment of
#Passive Left-Ventricular Myocardial Stiffness
#in Healthy Subjects and in Patients with Non-ischemic Dilated Cardiomyopathy
